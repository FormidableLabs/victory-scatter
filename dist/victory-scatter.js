...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pathHelpers = __webpack_require__(2);
	
	var _pathHelpers2 = _interopRequireDefault(_pathHelpers);
	
	var _victoryAnimation = __webpack_require__(32);
	
	var _victoryLabel = __webpack_require__(35);
	...
	var VictoryScatter = (function (_React$Component) {
	  ...
	  _createClass(VictoryScatter, [{
	    ...
	    value: function getSize(data) {
	      ...
	      if (data.size) {
	        return _lodash2["default"].max([data.size, 1]);
	      } else if (z && data[z]) {
	    ...
	    value: function renderLabel(position, data, index) {
	      ...
	      return component ? _react2["default"].cloneElement(component, props, children) : _react2["default"].createElement(_victoryLabel.VictoryLabel, props, children);
	    }
	  }, {
	    key: "renderPoint",
	    value: function renderPoint(data, index) {
	      ...
	      var path = pathFunctions[symbol].call(this, position.x, position.y, size);
	      var styleData = _lodash2["default"].omit(data, ["x", "y", "z", this.props.bubbleProperty, "size", "symbol", "name", "label"]);
	      var scatterStyle = _lodash2["default"].merge({}, this.style.data, styleData);
	    ...
	    value: {
	       ...
	       */
	      size: _victoryUtil2["default"].PropTypes.nonNegative,
	      /**
	       ...
	       */
	      symbol: _react.PropTypes.oneOf(["circle", "diamond", "plus", "square", "star", "triangleDown", "triangleUp"]),
	      /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.getState = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getState = __webpack_require__(20);
	var getStateKey = __webpack_require__(21);
	var mergeStyles = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  VictoryAnimation: __webpack_require__(33)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  VictoryLabel: __webpack_require__(36)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _victoryUtilLibStyle = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduceCssCalc = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reduceFunctionCall = __webpack_require__(40)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduceCssCalc = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var reduceFunctionCall = __webpack_require__(47)
